...
// example-data-api
const chartCardApiData = require('../docs/example-data-api/chartCardApi');
const chartBarApiData = require('../docs/example-data-api/chartBarApi');
const chartPieApiApiData = require('../docs/example-data-api/chartPieApi');
const chartPieApi1Data = require('../docs/example-data-api/chartPieApi1');
const chartLineApiData = require('../docs/example-data-api/chartLineApi');
const chartTableApiData = require('../docs/example-data-api/chartTableApi');
const chartTableNoColumnsApiData = require('../docs/example-data-api/chartTableNoColumnsApi');
const chartRetainApiData = require('../docs/example-data-api/chartRetainApi');
const chartLineAreaApiData = require('../docs/example-data-api/chartLineAreaApi');
