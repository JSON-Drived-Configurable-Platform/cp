                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>上传组件的类型</td>
                            <td>String</td>
                            <td>Upload/ImgUpload/VideoUpload</td>
                        </tr>
                        <tr>
                            <td>model</td>
                            <td>索引名称（必填）</td>
                        ...
                        <tr>
                            <td>multiple</td>
                            <td>默认是否在出现和消失时使用渐变的动画，动画时长可能会引起占位的闪烁</td>
                            <td>Boolean</td>
                            <td>true</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>accept</td>
                            <td>凭证信息接受上传的<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#attr-accept">文件类型</a></td>
                            <td>String</td>
                            <td>-</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>accessKey</td>
                            <td>需要单独取的后台返回数据的key(需要处理后端数据时，必传)</td>
                            <td>String</td>
                            <td>-</td>
                        </tr>
                    </tbody>
